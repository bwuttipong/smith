...
- created the new weekly report canvas "Weekly (June 15–19, 2026)" (ID: F0BBR8S0RKL) by cloning and updating "Weekly (June 8–13, 2026)" (ID: F0BABJ39FJ6). shared the link to Jeff's Slack DM.
- set the active weekly report canvas to "Weekly (June 15–19, 2026)" (ID: F0BBR8S0RKL) going forward.
